...
(function () {
  ...
  var I18N = {
    en: {
      ...
      egg_trigger: "* why 25 cm, and not 23.5?",
      egg_text: "One day, a customer measured one of our pizzas with a builder's tape measure: <strong>23.5 cm</strong>. It was true. We aim for 25 — the dough, however, does whatever it likes. 📏",
    ...
    es: {
      ...
      egg_trigger: "* ¿por qué 25 cm y no 23,5?",
      egg_text: "Un día, un cliente midió una de nuestras pizzas con una cinta métrica de obra: <strong>23,5 cm</strong>. Era verdad. Nosotros apuntamos a 25 — la masa, en cambio, hace lo que le da la gana. 📏",
    ...
    de: {
      ...
      egg_trigger: "* warum 25 cm und nicht 23,5?",
      egg_text: "Eines Tages hat ein Kunde eine unserer Pizzen mit einem Bau-Maßband gemessen: <strong>23,5 cm</strong>. Es stimmte. Wir zielen auf 25 — der Teig macht allerdings, was er will. 📏",
